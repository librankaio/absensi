                ...
                <div class="card">
                    ...
                    <form action="/postmasterdata" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggallahir" id="tanggallahir" value="{{ date("Y-m-d") }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Domisili</label>
                                        <input type="v" class="form-control" name="domisili">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="card-footer text-right">
                            <button class="btn btn-primary mr-1" type="submit" formaction="postmasterdata" id="confirm">Save</button>
